...
var myFunction = function(elem) {
    ...
    nextDecisionElem.scrollIntoView({behavior: "smooth", block: "start", inline: "nearest"});
};
...
function start() {
    ...
    document.getElementById("start").nextElementSibling.scrollIntoView({behavior: "smooth", block: "start", inline: "nearest"});
}